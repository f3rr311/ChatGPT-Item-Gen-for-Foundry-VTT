...
const ARMOR_DEFAULTS = {
  ...
  "padded armor":    { armorType: "light",  ac: 11, dexCap: null, stealthDisadvantage: true,  strengthRequirement: 0,  weight: 8,  cost: { value: 5, denomination: "gp" },    baseItem: "padded" },
  ...
  "leather armor":   { armorType: "light",  ac: 11, dexCap: null, stealthDisadvantage: false, strengthRequirement: 0,  weight: 10, cost: { value: 10, denomination: "gp" },   baseItem: "leather" },
  ...
  "studded leather armor": { armorType: "light",  ac: 12, dexCap: null, stealthDisadvantage: false, strengthRequirement: 0,  weight: 13, cost: { value: 45, denomination: "gp" },   baseItem: "studdedleather" },
  ...
  "hide armor":      { armorType: "medium", ac: 12, dexCap: 2,    stealthDisadvantage: false, strengthRequirement: 0,  weight: 12, cost: { value: 10, denomination: "gp" },   baseItem: "hide" },
  ...
  "scale":           { armorType: "medium", ac: 14, dexCap: 2,    stealthDisadvantage: true,  strengthRequirement: 0,  weight: 45, cost: { value: 50, denomination: "gp" },   baseItem: "scalemail" },
  ...
  "half plate armor":{ armorType: "medium", ac: 15, dexCap: 2,    stealthDisadvantage: true,  strengthRequirement: 0,  weight: 40, cost: { value: 750, denomination: "gp" },  baseItem: "halfplate" },
  ...
  "chainmail":       { armorType: "heavy",  ac: 16, dexCap: 0,    stealthDisadvantage: true,  strengthRequirement: 13, weight: 55, cost: { value: 75, denomination: "gp" },   baseItem: "chainmail" },
  ...
  "splint armor":    { armorType: "heavy",  ac: 17, dexCap: 0,    stealthDisadvantage: true,  strengthRequirement: 15, weight: 60, cost: { value: 200, denomination: "gp" },  baseItem: "splint" },
  ...
  "plate armor":     { armorType: "heavy",  ac: 18, dexCap: 0,    stealthDisadvantage: true,  strengthRequirement: 15, weight: 65, cost: { value: 1500, denomination: "gp" }, baseItem: "plate" },
...
export function parseDescriptionForArmor(text) {
  ...
  // (e.g., "studded leather" must match before "leather",
  //  "chain mail" before "mail", "half plate" before "plate")
  const sortedArmors = Object.keys(ARMOR_DEFAULTS).sort((a, b) => b.length - a.length);

  for (const armorName of sortedArmors) {
    if (clean.includes(armorName)) {
      return { ...ARMOR_DEFAULTS[armorName] };
    }
  }
