...
- **Generates a short, thematic item and name** via ChatGPT.
...
- **Generate and store an AI image locally** using Base64 encoding to download, ensuring that images persist across module updates.
